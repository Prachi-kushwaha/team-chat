...
import { DropdownMenu, DropdownMenuContent, DropdownMenuTrigger, DropdownMenuRadioGroup, DropdownMenuRadioItem, DropdownMenuItem } from "@/components/ui/dropdown-menu";
...
export const Profile = ({ memberId, onClose }: ProfileProps) => {
  ...
  const [UpdateDialog, confirmUpdate] = useConfirm("change role", "are you sure ")
  const [LeaveDialog, confirmLeave] = useConfirm("Leave workspace", "are you sure ")
  const [RemoveDialog, confirmRemove] = useConfirm("Remove Member", "are you sure ")
